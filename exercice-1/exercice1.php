...
<body>
    ...
    <main>
        <div>
            <!-- l'user agent contient des infos concernant la navigateur de l'utilisateur, comme son nom et sa version -->
            <p> User agent : <?php echo $_SERVER['HTTP_USER_AGENT'] ?> </p>
            <!-- renvoi ::1 à l'adresse IP car le serveur est en local et j'utilise une adresse IPV4 ou IPV6 -->
            <p> Son adresse IP : <?php echo $_SERVER['SERVER_ADDR'] ?> </p>
